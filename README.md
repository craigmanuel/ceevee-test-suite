...
The goal of this test suite is to validate the functionality, reliability, input handling, and usability of the feature based on the official documentation.

Documentation reviewed: https://cv-ai.work/docs

---

## Files
- `README.md` → project overview and instructions
- `TEST_SUITE.md` → complete manual QA test cases
